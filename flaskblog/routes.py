...
def save_picture(form_picture):
    ...
    picuture_fn=random_hex+f_ext
    picture_path=os.path.join(app.root_path,'static/profile_pics',picuture_fn)
    output_size=(125,125)
...
def update_post(post_id):
    ...
    return render_template("create_post.html",title='Post',form=form,legend='Update Post')
